...
const Home = () => {
  ...
  return (
    <>
      {/* ── Hero Banner ── */}
      <div className="relative w-full h-[400px] md:h-[560px] lg:h-[680px]  overflow-hidden shadow-xl bg-[#0b1437]">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#0a1232]/90 via-[#0a1232]/50 to-transparent" />
