export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto py-10 px-6 text-black">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-3">Frontend: Next.js</h2>
      <p className="text-lg leading-relaxed mb-6">
        The frontend is developed with <strong>Next.js</strong>, a React-based framework 
        offering server-side rendering, optimized performance, reusable components, and 
        SEO-friendly architecture. The UI is responsive, fast, and user-friendly.
      </p>
