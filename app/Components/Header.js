    ...
    <>
      ...
      {cartOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-80 bg-white shadow-xl z-50 p-5 flex flex-col">
            ...
            {items.length === 0 ? (
              ...
              <>
                <div className="flex-1 overflow-y-auto space-y-3 mb-4">
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-3 bg-gray-50 rounded-lg p-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm font-bold text-brand-dark">₹{Number(item.amount).toLocaleString("en-IN")}</p>
